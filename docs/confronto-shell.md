...
| arksh   | Object model + pipeline tipizzate + tipi numerici espliciti + encoding base64 nativo + cestino di sistema via plugin + autoload plugin configurabile + compatibilità POSIX + UX interattiva | Ancora in sviluppo, ecosistema piccolo, non adatto come shell di sistema |
