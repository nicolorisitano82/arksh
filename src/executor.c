...
static int execute_subshell_command(
  ...
  command_output[0] = '\0';
  status = execute_compound_body(subshell, compound, command_output, sizeof(command_output));
  if (arksh_shell_restore_after_subshell(shell, subshell, out, out_size) != 0) {
